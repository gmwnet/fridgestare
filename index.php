...
.invp-group-header{padding:6px 0 4px;margin-top:16px;font-size:13px;font-weight:600;color:#888;text-transform:uppercase;letter-spacing:.5px;border-bottom:1px solid #333}
...
<div id="invPage">
  <div style="display:flex;align-items:center;gap:8px;margin-bottom:8px">
    ...
    <button id="invpExport" style="padding:6px 12px;border:1px solid #555;border-radius:6px;background:#222;color:#fff;font-size:13px;cursor:pointer;white-space:nowrap">CSV</button>
  </div>
  <div id="invpList"></div>
...
?></select></span>
    ...
    <div style="margin-top:20px;padding-top:12px;border-top:1px solid #333;font-size:14px;color:#666;text-align:center">
      Version <?= htmlspecialchars($cfg['version'] ?? '1.00', ENT_QUOTES) ?>
      &middot; <a href="https://github.com/gmwnet/fridgestare/releases/latest" target="_blank" rel="noopener" style="color:#007aff;text-decoration:none">Check for upgrades</a>
    </div>
  </div>
